(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    var t = e.i(71645),
      r = (e, t, r, n, o, s, a, i) => {
        ...
        function u(t) {
          ...
          ((Array.isArray(e) ? e : [e]).forEach((e) => {
            ...
            r
              ? (l.classList.remove(...n), l.classList.add(s && s[t] ? s[t] : t))
              : l.setAttribute(e, t);
          }),
            (r = t),
            i && c.includes(r) && (l.style.colorScheme = r));
        }
        if (n) u(n);
        else
          try {
      ...
      c = ({
        ...
        let [E, S] = t.useState(() => d(c, p)),
          [T, P] = t.useState(() => ('system' === E ? f() : E)),
          k = g ? Object.values(g) : h,
          x = t.useCallback(
            (e) => {
              let t = e;
              if (!t) return;
              ...
              let o = g ? g[t] : t,
                ...
                c = (e) => {
                  'class' === e
                    ? (l.classList.remove(...k), o && l.classList.add(o))
                    : e.startsWith('data-') && (o ? l.setAttribute(e, o) : l.removeAttribute(e));
                };
              if ((Array.isArray(y) ? y.forEach(c) : c(y), i)) {
        ...
        (t.useEffect(() => {
          ...
          t.useEffect(() => {
            let e = (e) => {
              e.key === c && (e.newValue ? S(e.newValue) : C(p));
            };
            return (
      ...
      u = t.memo(
        ({
          ...
          let m = JSON.stringify([o, n, i, e, c, l, s, a]).slice(1, -1);
      ...
      f = (e) => (e || (e = window.matchMedia(o)), e.matches ? 'dark' : 'light');
    e.s([
      'ThemeProvider',
      0,
      (e) =>
      ...
      function () {
        let [e, n] = (0, r.useState)(!1),
          ...
          a = (0, r.useMemo)(
            () =>
              !('u' < typeof document) &&
              Array.from(document.styleSheets).some((e) => {
                try {
                  return (
                    (e.href || '').includes('font-awesome') ||
                    (e.href || '').includes('fontawesome')
                  );
                } catch {
                  return !1;
                }
        ...
        return (
          (0, r.useEffect)(() => {
            let e = () => {
              ...
              (s(t > 0 ? Math.min(e / t, 1) : 0), n(e > 100));
            };
            return (
          ...
          (0, t.jsxs)('button', {
            ...
            style: {
              ...
              transform: e ? 'translateY(0) scale(1)' : 'translateY(12px) scale(0.96)',
            },
            children: [
              (0, t.jsxs)('svg', {
                ...
                children: [
                  (0, t.jsx)('circle', {
                    className: 'back-to-top__ring-base',
                    cx: '18',
                    cy: '18',
                    r: '16',
                  }),
              ...
              a
                ? (0, t.jsx)('i', {
                    className: 'fa-solid fa-chevron-up back-to-top__arrow',
                    'aria-hidden': 'true',
                  })
                : (0, t.jsx)('svg', {
  ...
  (e) => {
    ...
    var t = e.i(43476),
      ...
      n = e.i(71645);
    function o() {
      let { resolvedTheme: e } = (0, r.useTheme)();
      return (
        (0, n.useEffect)(() => {
          if (e) {
            ...
            try {
              (localStorage.setItem('spire-theme', e),
                localStorage.setItem('quiz-theme-preference', e));
            } catch {}
          }
        }, [e]),
        null
    ...
    e.s([
      ...
      0,
      function ({ children: e }) {
        return (0, t.jsxs)(r.ThemeProvider, {
          attribute: 'class',
