  ...
  const contentArticles = [
    {
      ...
      intro:
        'This document outlines our commitment to protecting your privacy, explains our data practices, and provides our terms of service. We believe in transparency and want you to understand how we handle your information when you use Quiz The Spire.',
      highlights: [
        {
          title: 'Privacy-First Design',
          content:
            'Quiz The Spire employs privacy-by-design principles, collecting only essential data to enhance your gameplay experience while implementing robust security measures to protect your information.',
        },
        {
          title: 'Environmental Data Usage',
          content:
            'We collect anonymized environmental sensor data (temperature, light levels) exclusively to dynamically adjust game difficulty and timer mechanics. This data is never linked to your identity or used for tracking purposes.',
        },
        {
          title: 'Your Data Rights',
          content:
            'You maintain full control over your information with rights to access, correct, or delete your data at any time by contacting our support chat.',
        },
      ],
      cards: [
        {
...

    {
      ...
      intro:
        'Maximize knowledge acquisition and retention through research-supported learning methodologies. These techniques are grounded in cognitive psychology and neuroscience principles to enhance long-term memory formation and recall efficiency.',
      highlights: [
        {
          title: 'Cognitive Science Insight',
          content:
            'Spaced repetition leverages the spacing effect, demonstrating 200% greater long-term retention compared to massed practice (cramming) by optimizing memory consolidation processes.',
        },
        {
          title: 'Environmental Context Effects',
          content:
            'Research on context-dependent memory shows that studying under conditions similar to testing environments can enhance performance by approximately 30% through improved retrieval cues.',
        },
        {
          title: 'Retrieval Practice Benefits',
          content:
            'Testing effect research demonstrates that active retrieval strengthens neural pathways through synaptic plasticity, making future recall more efficient and durable than passive review alone.',
        },
      ],
      cards: [
        {
          ...
          content:
            'Deliberate practice of recalling information without external cues enhances long-term memory formation:',
          list: [
        ...
        },
        {
          ...
          content:
            'Neural processing during sleep critical for memory stabilization and integration:',
          list: [
...

    {
      ...
      intro:
        'Before breath became currency, before the Pneuma-Meters, there was only the day the air itself betrayed them. Jacob and his little sister Lila witnessed the beginning of the Great Chokingthe moment the world shifted from living to surviving.',
      highlights: [
        {
          title: 'The First Stings',
          content:
            'A strange, acrid haze creeps into the city, making every breath taste sharp and metallic. Children cough, parents panic, and neighbors rush to seal their homes against an invisible invader.',
        },
        {
          title: "The Family's Fear",
          content:
            'Jacob’s mother draws the curtains tight, his father staggers home with blistered lips and burning lungs, and Lila clings to her brother, frightened but too young to understand.',
        },
        {
          title: 'A City Holding Its Breath',
          content:
            'Through the walls come the sounds of coughing, sobbing, and panic, until the whole building seems to wheeze as one. For the first time, Jacob feels the air not as life, but as threat.',
        },
      ],
      sections: [
        {
        ...
        },
        {
          ...
          content:
            'Jacob’s father returns from outside, carrying the horror of the streets with him:',
          list: [
...

    {
      ...
      intro:
        'The haze did not pass. It thickened, and with it came the merchants of airmen who wore filters and carried ledgers instead of mercy. For Jacob and Lila, the horror was no longer the burning of their lungs, but the price stamped on survival.',
      highlights: [
        {
          title: 'The Stranger’s Arrival',
          content:
            'A man in a gray respirator, armed with a ledger and an official seal, comes to the family’s apartment. His voice is muffled, his words clipped: the parents’ debt has been converted into a contract.',
        },
        {
          title: 'The Parents’ Bargain',
          content:
            'In order to keep their children breathing, Jacob’s mother and father signed themselves awaysold their labor, their freedom, perhaps even their livesto the Air Authority.',
        },
        {
          title: 'Children Left Behind',
          content:
            'The stranger informs Jacob and Lila that they are to remain in the apartment, their air strictly rationed, while their parents work off the debt. Alone, frightened, they must now learn to survive in a world where even oxygen is counted and sold.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'Before the Great Choking, their apartment was ordinaryone among thousands of concrete blocks crammed together in the city’s smog-stained skyline. Now, every crack, every sealed window, every possession takes on the weight of survival. For Jacob and Lila, the house is no longer a home; it is a lung, fragile and failing.',
      highlights: [
        {
          title: 'A Yellow Room',
          content:
            'Jacob’s room, painted a fading yellow by his mother years ago, still carries the stubborn memory of sunshine. Toys sit untouched, each breath of air too valuable to waste on play.',
        },
        {
          title: 'The Sister’s Corner',
          content:
            'Lila’s bed is crowded with stuffed animals, their stitched smiles gathering dust. The shelf above it holds cracked storybooks, relics from a world where bedtime wasn’t suffocating.',
        },
        {
          title: 'The Apartment as Fortress',
          content:
            'Curtains nailed into place, towels stuffed into vents, water buckets lined against wallstheir home is both barricade and prison, built against an enemy that seeps through the cracks.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'Every corner of Jacob and Lila’s apartment has become charged with meaning. It is no longer just a place to liveit is a fragile system, an organism, where each room serves a role in their fight against suffocation. From bathroom to balcony, the details of the home speak of a family’s desperate attempt to keep the poison out and the children alive.',
      highlights: [
        {
          title: 'The Bathroom',
          content:
            'Once a space of cleanliness, now a chamber of scarcity. Buckets of water line the tiles, mildew creeps along the grout, and the mirror reflects gaunt faces beneath flickering light.',
        },
        {
          title: 'The Hallway',
          content:
            'The narrow spine of the apartment, filled with shoes, coats, and sealed vents. Every step echoes against walls where family photographs hang, fading under a thin film of dust.',
        },
        {
          title: 'The Balcony and Closet',
          content:
            'The balcony, sealed with plastic and boards, offers a blurred view of the dying city. The closet, crammed with tools and makeshift supplies, has become an arsenal of survival.',
        },
      ],
      sections: [
        {
          title: 'The Bathroom',
          content:
            'No longer a room for routine comfort, the bathroom has become one of the most important chambers in the apartment:',
          list: [
        ...
        },
        {
          title: 'The Hallway',
          content:
            'The narrow passage between rooms has transformed into both memory wall and defensive barrier:',
          list: [
        ...
        },
        {
          ...
          content:
            'Once the heart of the home, the living room has become a strange mix of sanctuary and suffocation:',
          list: [
        ...
        },
        {
          ...
          content:
            'The smallest space in the apartment has become their storehouse of survival tools:',
          list: [
...

    {
      ...
      intro:
        'When Jacob and Lila step outside their barricaded home for the first time, they discover a neighborhood half-dead, half-plundered, where even air is hunted. Armed with failing masks and a handful of supplies, they return to find their sanctuary violated. The city is no longer theirsit belongs to a new master.',
      highlights: [
        {
          title: 'First Steps Outside',
          content:
            'With expired masks and a patched air filter, Jacob and Lila leave their apartment, carrying only what they can strap to their backs. The world outside is stranger and more hostile than they imagined.',
        },
        {
          title: 'The Ruined Neighborhood',
          content:
            'Their block has become a graveyard of abandoned cars and suffocated homes. They scavenge small suppliescans, cloth, a rusted kettlebut everywhere they feel watched.',
        },
        {
          title: 'The Theft',
          content:
            'Returning to their home, they discover the door forced open, water spilled, food gone, and the precious Pneuma-Meter smashed. Air thieves have gutted their sanctuary.',
        },
        {
          title: 'A New Ruler',
          content:
            'Word spreads that the city has fallen under the control of Hiroto Tanaka, a wealthy industrialist with his own private army. He now controls oxygen distributionand through it, life itself.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'With their home gutted and the city under Hiroto Tanaka’s rule, Jacob and Lila must leave or suffocate. But to escape means surviving the poisoned streets, the private patrols, and the sheer math of how many breaths they can afford to take along the way.',
      highlights: [
        {
          title: 'Broken Sanctuary',
          content:
            'Their apartment, once a fragile fortress, lies shattered. They cannot rebuild here; every crack is a reminder that thieves and soldiers can reach them anytime.',
        },
        {
          title: 'Supplies Counted',
          content:
            'Jacob inventories what little remains: a rusted kettle, two cans of food, a jar of beans, scraps of cloth, duct tape, tarps, and one water jug. The masks they wear are failing.',
        },
        {
          title: 'The Breath Economy',
          content:
            'Without the Pneuma-Meter, their air usage is guesswork. Each breath is a gamble, a calculation of distance against survival.',
        },
        {
          title: 'Choosing a Path',
          content:
            'Whispers speak of two possible exits: the guarded main highway, or the abandoned subway tunnels, where the haze hangs thicker but soldiers dare not go.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'Twelve hours after the raid, Jacob and Lila’s apartment has turned against them. The once-yellow walls sweat green with rot, the paint peeling as if the house itself is choking. Their sanctuary has become a tomb, and the only option left is flight into a city ruled by poison and patrols.',
      highlights: [
        {
          title: 'The House Rotting',
          content:
            'Moisture seeps from the walls, paint bubbling into green blisters, air tasting metallic and thick. Even the silence feels heavy, as if the house itself is dying around them.',
        },
        {
          title: 'Final Departure',
          content:
            'At nightfall, Jacob straps on the rattling masks, gathers the bundle of food, water, cloth, and tools, and leads Lila into the hallway. Behind them, the apartment wheezes its last breath.',
        },
        {
          title: 'The Dangers Outside',
          content:
            'The streets are patrolled by Tanaka’s soldiers, shadows with rifles and hissing respirators. The air is filled with toxins and whispers of thieves. Each step feels stolen.',
        },
        {
          title: 'The Choice',
          content:
            'At the city’s edge they must choose: the guarded highway, where soldiers decide who lives, or the abandoned subway tunnels, where the haze thickens but freedom may still exist.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'Choosing the subway over the guarded highway, Jacob and Lila descend into the underground where the city’s forgotten veins run thick with haze and silence. The tunnels are collapsing, but in their ruins lies the only path to freedom.',
      highlights: [
        {
          title: 'The Descent',
          content:
            'The subway stairwell swallows them, every step echoing against damp walls. The haze thickens, their masks whine, and the city above disappears.',
        },
        {
          title: 'A Maze of Rot',
          content:
            'Collapsed ceilings, flooded passages, and skeletal trains block their path. The tunnels feel alive, groaning under the weight of the poisoned world above.',
        },
        {
          title: 'The Struggle to Breathe',
          content:
            'Air grows heavier the deeper they go, filters rattling, lungs straining. Each breath feels like pulling through cloth soaked in iron.',
        },
        {
          title: 'The Exit',
          content:
            'After hours of stumbling through debris and darkness, the tunnels break open into the outskirtsair still toxic, but lighter, freer than the suffocating choke of the city behind them.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'Beyond the city walls, Jacob and Lila finally see the heart of the Great Choking: Tanaka’s factory, a monstrous machine that feeds on air itself. But its fall is not salvationonly another wound in a dying world. As explosions rip through its reactors, the children’s failing filters drag them into the silence from which no escape exists.',
      highlights: [
        {
          title: 'The Factory of Breath',
          content:
            'A sprawling industrial carcass, belching haze into the sky, where oxygen is harvested, taxed, and sold. It is the machine that chained a city by the lungs.',
        },
        {
          title: 'The First Collapse',
          content:
            'One reactor has already exploded, smoke curling upward in black columns, scattering ash across the outskirts.',
        },
        {
          title: 'The Second Strike',
          content:
            'A plane descends, silent in the haze until impact, slamming into the second reactor. The detonation lights the sky orange, a false sunrise over a ruined world.',
        },
        {
          title: 'The Filters Failing',
          content:
            'Their masks wheeze, then sputter, until the filters rattle empty. Every inhale drags poison deeper into their lungs.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'They appeared first as whispers, then as womenbeautiful, magnetic, and impossible to resist. By daylight, they laughed and charmed in village markets, weaving themselves into lives as friends, neighbors, and lovers. But by night, they revealed their true forms: Ash-Bloods, a new race of predators who drained men of their very essence and remade them in their image. A fate worse than death, for the drained became Ash-Bloods themselves, hollowed out and reborn as hunters of their own kind.',
      highlights: [
        {
          title: 'By Day, Deception',
          content:
            'Ash-Bloods mask themselves in illusionmakeup, clothes, and a practiced charisma. They are indistinguishable from ordinary women, until the daylight fades.',
        },
        {
          title: 'By Night, Hunger',
          content:
            'Under darkness they hunt, slipping into bedrooms or luring men into shadows. Their touch extracts life, leaving behind a husk or worsean infected victim who awakens no longer human.',
        },
        {
          title: 'A Fate Worse Than Death',
          content:
            'Those who fall to a Ash-Blood do not stay men. Their minds unravel, their bodies twist, until they awaken in the form of the very thing they feareda new Ash-Blood, eager to hunt.',
        },
        {
          title: 'The Mountain Resistance',
          content:
            'High in the mountains, a band of men trains to resist. They fight with brutal discipline, targeting the illusionstearing away disguises, stripping glamour, exposing the predator beneath. Their champion is Kael Hoff.',
        },
      ],
      sections: [
        {
      ...
      highlights: [
        {
          ...
          content:
            'Built into a cliffside cave, the resistance stronghold is carved with tunnels and barricades, hidden beneath smoke-dampened fires and camouflaged tarps.',
        },
        {
          title: 'The Training of Glamour-Breaking',
          content:
            'Every day, recruits spar until bloodied, learning to tear illusions aparttargeting disguises first, then striking the creature beneath.',
        },
        {
          title: 'Weapons Against Shadows',
          content:
            'They fight with fists, clubs, and sharpened tools scavenged from ruins, but their greatest weapon is ritual disciplinebreath control, chants, and focused rage to block infection.',
        },
        {
          title: 'The Leadership of Kael Hoff',
          content:
            'Kael trains harder than any, his scars a reminder of what infection can do. He is both mentor and executioner, demanding his men survive the glamour or die trying.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'Beneath the mountain stronghold, villages lie in shadow. Here the Ash-Bloods walk openly by day, cloaked in smiles and false warmth, their presence woven into every market, tavern, and home. Life continues under their gaze, but it is no longer human lifeit is life bent to serve predators, where trust is a liability, and every gesture might mask a snare.',
      highlights: [
        {
          title: 'The Market of Masks',
          content:
            'Villages thrive with activity by day, but every interaction is charged with dread. Men avoid meeting women’s eyes too long, afraid to see something shimmering beneath the surface.',
        },
        {
          title: 'The Night Hunts',
          content:
            'At sundown, doors bolt shut, candles are extinguished, and men pray their walls are thick enough to keep Ash-Bloods out. Few prayers are answered.',
        },
        {
          title: 'The Hollowed Ones',
          content:
            "Infected men do not diethey change. They return as women who smile too widely, their voices carrying echoes of the men they once were. Villagers call them 'the Hollowed.'",
        },
        {
          title: 'The Rule of Fear',
          content:
            'No laws remain but the Ash-Bloods’ hunger. Villagers barter food, tools, and loyalty to appease them. Betrayal is common; survival is currency.',
        },
      ],
      sections: [
        {
          ...
          content:
            'At first glance, life continues, but beneath the surface lies constant tension:',
          list: [
...

    {
      ...
      intro:
        'The Ash-Bloods do not vanish with daylight. They retreat to lairs hidden beneath the villages, in ruins, and in forgotten halls of stone. There, their illusions fade, their painted faces run, and their true nature reveals itself in rituals of hunger and power. Understanding their lairs means understanding their dominionfor the Ash-Bloods are not wild beasts, but a race with order, hierarchy, and a hunger woven into every ritual.',
      highlights: [
        {
          title: 'The Hidden Nests',
          content:
            'Every village shelters at least one laircellars, caves, or collapsed sewersmasked by glamour to appear abandoned or harmless.',
        },
        {
          title: 'The Unmasking',
          content:
            'Within their lairs, Ash-Bloods shed disguises. Their flesh shifts, makeup melts, and their forms warp between human and monstrous.',
        },
        {
          title: 'The Ritual of Feeding',
          content:
            'They do not simply drain men; they conduct ceremonies of extraction, drinking essence in circles, binding the victim’s screams into chant.',
        },
        {
          title: 'The Hierarchy of Packs',
          content:
            'Ash-Bloods hunt in packs led by Matronsolder, more grotesque forms who command younger sisters. Rivalries burn, but hunger unites them.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'From the high ridges, Kael Hoff led his fighters down into the valley, where a village cellar concealed a Ash-Blood nest. For months, they had trained for this nightlearning to strike through illusions, to ignore the false beauty, and to trust only what their fists could shatter. Now, as the torches burned low and the soil trembled with ritual songs below, the resistance entered the lair of nightmares.',
      highlights: [
        {
          title: 'The Descent',
          content:
            'Through a broken tavern door and into a hidden cellar, the fighters marched into choking darkness.',
        },
        {
          title: 'The Breaking of Glamour',
          content:
            'Ash-Bloods shimmered with false faces, but Kael’s fighters struck at their clothes, their painted lips, and their mirrorsstripping illusions away until monsters stood revealed.',
        },
        {
          title: 'The Clash of Ritual and Fist',
          content:
            'As Ash-Bloods circled in chant, Kael and his men disrupted the rhythm with their own blows, turning ceremony into chaos.',
        },
        {
          title: 'The First Victory',
          content:
            'For the first time, a pack was broken. Yet victory came at a cost, for not all fighters left the lair alive, and whispers of something larger stirred in the dark.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'When the tavern cellar burned, its smoke rose like a beacon. The villagers gathered in awe and fear, whispering Kael Hoff’s name as if it were a spell. But fire spreads in more ways than one: the raid awakened hope among men, suspicion among women, and fury among the Ash-Bloods. In the days that followed, ash fell on roofs like black snow, and Kael’s fighters prepared for a retaliation that would test everything they had built.',
      highlights: [
        {
          title: 'The Village Divided',
          content:
            'Men whispered of freedom while women watched with unreadable eyes, some offering aid, others turning cold.',
        },
        {
          title: 'The Retaliation',
          content:
            'That night, the Ash-Bloods struck backnot in the tavern ruins, but in homes, dragging men screaming into the dark.',
        },
        {
          title: 'The Seeds of Strategy',
          content:
            'Kael gathered his fighters, charting maps in dirt and ash, speaking of tunnels and lairs deeper still.',
        },
        {
          title: 'The First Whispers of the Queen',
          content:
            'Survivors muttered of a voice in the smoke, a Queen who stirred when fire touched her symbols.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'Smoke still lingered in the village above when Kael Hoff led his fighters below again. This time, they would not raid a shallow cellar or a half-forgotten sewerthey would descend into the deep tunnels, where even villagers feared to whisper. Here, the air was colder, the stones older, and the shadows heavier. And here, for the first time, the resistance felt the pulse of something vast, something ancient, something that whispered not with one voice, but with manythe Queen.',
      highlights: [
        {
          title: 'The Descent Below',
          content:
            'The tunnels spiraled downward, carved by hands long dead, lined with bones that marked the forgotten.',
        },
        {
          title: 'The Signs of the Queen',
          content:
            'Symbols burned faintly on walls, shifting when torches flickeredcrowns of eyes, thrones of teeth.',
        },
        {
          title: 'The Lurking Packs',
          content:
            'Ash-Bloods prowled in silence here, not with glamour, but with raw hungercreatures closer to beasts than women.',
        },
        {
          title: 'The Voice in the Stone',
          content:
            'At the tunnel’s heart, the fighters heard it: a low hum that was not echo, not wind, but a voice vibrating through rock.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'After the retreat from the deep tunnels, silence clung to Kael Hoff’s camp. No man spoke of the voice in the stone without shivering, yet whispers crept among them. In the villages, in ruins, in carvings older than memory, fragments of the Queen’s myth surfaced. She was not a beast, nor a woman, nor a spiritbut something vaster, a hunger woven into the earth itself, clothed in beauty only to mask her endless maw.',
      highlights: [
        {
          title: 'The Songs of Grandfathers',
          content:
            'Old men hummed broken melodies, half lullabies, half dirges, warning of the Queen who dreams beneath the soil.',
        },
        {
          title: 'The Carvings in Stone',
          content:
            'On cliff walls and ruined chapels, symbols of thrones and crowns etched centuries ago hinted that she had always been here.',
        },
        {
          title: 'The Manuscript of Ash',
          content:
            'A tattered book found in a burned library spoke of a ‘Bride of Breath’ who fed on devotion as much as flesh.',
        },
        {
          title: 'The Promise of Rising',
          content:
            'Every fragment ended the same way: when the Queen stirs, no wall, no mountain, no fist can hold her back.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The whispers of the Queen weighed heavy on the camp, but Kael Hoff saw through them. If the Queen fed on love, then fists alone would never end her hunger. The answer, absurd as it seemed, was clear: he would make her fall in love with him. And then, in the only language he knewfists, sweat, and grithe would fight her in the ring. The apocalypse’s darkest chapter would become its strangest romance.',
      highlights: [
        {
          title: 'The Romantic Strategy',
          content:
            'Kael Hoff decides love is a weapon sharper than any blade, and prepares to woo the Queen into lowering her guard.',
        },
        {
          title: 'The Descent with Flowers',
          content:
            'Instead of torches and spears, he brings roses, candles, and an old bottle of perfume scavenged from a raided village.',
        },
        {
          title: 'The Ring of Stone',
          content:
            'At the Queen’s throne, an arena forms from shifting rockher power shaping their duel into something between courtship and combat.',
        },
        {
          title: 'The First Round: Words',
          content:
            'Before fists, there is banterKael’s cocky charm against the Queen’s centuries of sultry menace.',
        },
        {
          title: 'The Second Round: Fists',
          content:
            'The romance becomes violence, the violence becomes romance, each punch laced with subtext, sweat, and absurd intimacy.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The ring of stone was slick with sweat, dust, and shadows. Kael Hoff stood bloodied but unbroken, while the Queen loomed above him, her crown of eyes dimming, her laughter softer. Blow after blow had carried something stranger than violenceit carried affection. And at last, against all odds, the Queen had fallen in love. But Kael’s fists had one last word to say.',
      highlights: [
        {
          title: 'The Dance of Violence and Love',
          content:
            'Every strike had been both flirtation and defiance, and the Queen could no longer tell the difference.',
        },
        {
          title: 'Her Confession',
          content:
            'In the middle of the fight, the Queen whispered the unthinkable: that she desired Kael, not his ruin but his embrace.',
        },
        {
          title: 'Kael’s Last Words',
          content:
            'With roses crushed underfoot and torches dying, Kael leaned close, smiled, and said: ‘No goon.’',
        },
        {
          title: 'The Knockout',
          content:
            'His fist connected with her jaw in a crack like an earthquake, and the Queen fell silent for the first time in centuries.',
        },
        {
          title: 'The Breaking of the Curse',
          content:
            'Her fall unspooled the Ash-Blood hunger; across the land, women twisted back into their true human selves, free from her control.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The city never used to breathe. Now it does. It groans, it wheezes, it beats with a rhythm no human heart could match. Somewhere in the towers of gristle and glass, the Meat Clock ticks, every hour bringing a fresh demand. At the first strike of flesh against bone, people gathered in the square, staring up, waiting to see what the clock would want this time. Below, in a cramped apartment with wallpaper peeling like scabs, a young man named Erik laced his boots. He already knew the truth: today, the Clock would call his name.',
      highlights: [
        {
          title: 'The Meat Clock',
          content:
            'A monument of flesh and steel that governs the city by demands  each strike of the hour brings a ritual sacrifice, a task, or worse.',
        },
        {
          title: 'Erik',
          content:
            'A factory-worker-turned-smuggler, scarred from years of carrying contraband lungs through back alleys.',
        },
        {
          title: 'The Summons',
          content:
            'The first strike of the Clock in this story calls for something no one has seen before: not blood, not bone, but a single *memory*.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'By evening, the square had changed. The Clock’s demand echoed through every alley, and merchants were already at work. Stalls sprouted like tumorstents stitched from skin, jars lined with glass teetheach promising to buy, sell, or trade the one thing everyone suddenly feared to lose: memory. Erik pushed through the crowds, keeping his respirator close. He had seen lungs, marrow, even entire spines traded before. But never this. Never laughter, never love, never a face in the dark.',
      highlights: [
        {
          title: 'The Market Erupts',
          content:
            'Merchants rise like vultures, selling devices to bottle memories, trading nostalgia as if it were wine.',
        },
        {
          title: 'The Enforcers',
          content:
            'Steel-masked men drag citizens into booths where their minds are drained, leaving them hollow-eyed.',
        },
        {
          title: 'The Memory Thieves',
          content:
            'In the alleys, black-market surgeons stalk, eager to carve memories before the Clock takes them officially.',
        },
        {
          title: 'Erik’s Dilemma',
          content:
            'He knows which memory they’ll wanthis sister’s laughbut swears he’ll never give it up.',
        },
      ],
      sections: [
        {
...

    {
      ...
      highlights: [
        {
          title: 'The Stranger',
          content:
            'A man in a coat of burned pages, eyes glowing faintly, who knows the true hunger of the Clock.',
        },
        {
          title: 'The Wells',
          content:
            'Reservoirs beneath the city where stolen memories drip and swirl, guarded by enforcers and whispering machines.',
        },
        {
          title: 'The Proposal',
          content:
            'If Erik can reach the Wells, he can hide his sister’s laugh where the Clock cannot reachor steal enough memories to buy his way free.',
        },
        {
          title: 'The Risk',
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            'That night, beneath the stench of the Memory Market, Erik and Calis pried open a rusted grate:',
          list: [
...

    {
      ...
      intro:
        'The tunnels led them downward for hours, or maybe minutesthe air stole time the way it stole breath. When the last torch burned low, the walls opened into a cavern so vast it might have been the inside of a skull. The Wells stretched below, pools of liquid memory glowing in shades of pale blue, crimson, and sickly green. Erik gripped the rusted railing of the bridge, and for the first time, he heard it: laughter, his sister’s laughter, rising faint and broken from the depths.',
      highlights: [
        {
          title: 'The Cavern',
          content:
            'A vast chamber of dripping stalactites and bridges of rust, with vats of liquid memory swirling below.',
        },
        {
          title: 'The Sound',
          content:
            'The Wells echo with fragments of stolen memoriesvoices, cries, songs, laughterinterwoven like static.',
        },
        {
          title: 'The Watchers',
          content:
            'Enforcers and pale, eyeless figures patrol the bridges, their steps synchronized with the heartbeat of the Clock.',
        },
        {
          title: 'The Temptation',
          content:
            'Memories call out to intruders, offering glimpses of what they’ve lost, trying to pull them into the pools.',
        },
        {
          title: 'The Plan',
          content:
            'Calis explains how to drown a memory so the Clock cannot consume itbut warns Erik of the cost.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The pools bubbled louder as Erik approached the edge, the laughter rising until it was the only sound left. He knelt, trembling, a vial in his hand. The plan was simple: drown the sound of his sister’s laugh beneath countless others, hide it forever. But the pool had its own ideas. The surface rippled and rose like a living skin, showing him everything he’d lostand everything he could take. Calis hissed behind him, ‘Decide. Now.’',
      highlights: [
        {
          title: 'The Attempt',
          content:
            'Erik tries to drown his sister’s laugh into the Wells, but the pool resists, pulling at him with images of his past.',
        },
        {
          title: 'The Visions',
          content:
            'The Wells show Erik not only his childhood but futures that never happenedtemptations to break his resolve.',
        },
        {
          title: 'The Choice',
          content:
            'Erik refuses to let go. Instead of drowning the memory, he draws it backand with it, something else.',
        },
        {
          title: 'The Consequence',
          content:
            'The Wells lash out violently, awakening guardians and shaking the cavern. Erik escapes with power but also corruption.',
        },
      ],
      sections: [
        {
...

    {
      ...
      highlights: [
        ...
        },
        {
          title: 'The Warning',
          content:
            'Calis tells Erik that once the Clock notices you, there is no hiding. The hunters will come.',
        },
        {
          title: 'The Decision',
          content:
            'Erik realizes he can’t just run. He must decide whether to flee the city entirelyor strike at the Clock before it strikes him.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'Erik clenched his fists until the blue glow dimmed beneath his skin. He thought of his sister’s laugh, burning inside him like a coal, and made his choice. He would not flee. The Clock had stolen enoughit would not take her too. Calis saw the decision in his face before Erik spoke. ‘Then we climb,’ the librarian said, his burned coat whispering like turning pages. Above them, the Clocktower loomed, exhaling steam and smoke, every breath a warning.',
      highlights: [
        {
          title: 'The Resolve',
          content:
            'Erik chooses to face the Clock rather than flee, setting his course toward the tower.',
        },
        {
          title: 'The City Against Them',
          content:
            'As they begin the ascent, the streets twist and resist, the architecture shifting like a living machine.',
        },
        {
          title: 'The Hunters',
          content:
            'They encounter the first of the Clock’s huntersfigures born of silence, moving only between the tolls.',
        },
        {
          title: 'The Growing Power',
          content:
            'Erik’s veins blaze brighter, and his body trembles as the laugh inside him grows unstable.',
        },
        {
          title: 'The Tower’s Breath',
          content:
            'The closer they draw, the more alive the Clocktower becomesits gears groaning like lungs, its bells like a heartbeat.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The plaza before the Clocktower wasn’t stone, not entirely. The surface rippled in places like water, cracked in others like glass. The tower’s shadow didn’t fall straight but bent in impossible angles, cutting across the square like knives. Erik and Calis stood at its edge, listening. The hunters were already waiting for them, silent in the stillness between tolls. And the Clock was breathing louder.',
      highlights: [
        {
          title: 'The Plaza',
          content:
            'A warped, shifting space at the base of the tower, its ground unstable and dangerous.',
        },
        {
          title: 'The Hunters’ Trap',
          content:
            'Dozens of shadow-figures gather, their movements timed to the silence between bells.',
        },
        {
          title: 'The Distortion',
          content:
            'Time itself bends in the plaza, forcing Erik and Calis into loops and false steps.',
        },
        {
          title: 'The Unstable Power',
          content:
            'Erik unleashes bursts of sound that ripple realitybut each use frays his body further.',
        },
        {
          title: 'The Breach in the Wall',
          content:
            'At last they spot a potential entry into the towernot the main gates, but a crack leaking steam.',
        },
      ],
      sections: [
        {
      ...
      highlights: [
        {
          title: 'The Breach',
          content:
            'Erik and Calis break through the tower’s hidden crack, leaving the plaza behind.',
        },
        {
          title: 'The Trials Begin',
          content:
            'Inside the tower, each level tests them with challenges of strength, endurance, and wisdom.',
        },
        {
          title: 'The Tower’s Nature',
          content:
            'The interior feels alive: walls shifting, gears grinding like ribs, corridors closing like throats.',
        },
        {
          title: 'The Core Revealed',
          content:
            'At the deepest chamber, they discover the truth: Kael Hoff, bound and fused into the Clock’s machinery.',
        },
        {
          title: 'The Choice Ahead',
          content:
            'To destroy the Clock, Erik must confront not just the machine, but the man at its heart.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The chamber trembled as Erik and Calis approached Kael Hoff’s suspended form. But before they could draw closer, the chains above snapped loose, lowering a monstrous figure forged of bronze and glass. The guardianhalf-machine, half-shadowdescended from the tower’s ceiling, its eyes burning with borrowed memory. This was no hunter, no echo. This was the Clock’s hand, raised to defend its heart.',
      highlights: [
        {
          title: 'The Guardian Descends',
          content:
            'A towering construct, born of gears, shadow, and human bone, blocks the path to the core.',
        },
        {
          title: 'The Trial of Flesh',
          content:
            'The guardian strikes with brutal force, testing Erik’s strength and Calis’s resolve.',
        },
        {
          title: 'The Mortal Wound',
          content:
            'Though they fight with everything they have, both Erik and Calis are grievously injured.',
        },
        {
          title: 'The Victory',
          content:
            'In a final act of defiance, Erik unleashes the laugh’s power, shattering the guardian.',
        },
        {
          title: 'The Final Choice',
          content:
            'Weakened and bleeding, they stand before Kael Hoffforced to choose whether to end him and the Clock, or collapse with it.',
        },
      ],
      sections: [
        {
...

    {
      title: 'The Last Toll',
      intro:
        'The chamber dimmed as the guardian’s wreckage cooled, leaving only the hiss of leaking pipes and the slow, uneven breathing of the man suspended in chains. Kael Hoff lifted his head, eyes glowing faintly, his voice trembling but deep. ‘You’ve come so far. Too far to crawl back into dust.’ The chains rattled as though in agreement. ‘End me, and you end the world. Or… take my place. Rule it.’',
      highlights: [
        {
          title: 'The Temptation',
          content:
            'Kael offers Erik and Calis the chance to inherit his throne within the Clock, wielding its power.',
        },
        {
          title: 'The Refusal',
          content:
            'Despite their wounds and exhaustion, they reject the offer, clinging to the memory of the laugh rather than dominion.',
        },
        {
          title: 'The Killing Blow',
          content:
            'With the last of their strength, Erik and Calis destroy Kael Hoff and sever the Clock’s core.',
        },
        {
          title: 'The Collapse',
          content:
            'The tower crumbles, the hunters vanish, and the bells fall silent for the first time in living memory.',
        },
        {
          title: 'The Aftermath',
          content:
            'The world outside begins to shift in strange and uncertain ways, hinting at what is to come in a second tale.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The city awoke to silence. For generations, its people had lived under the constant toll of the Clockevery hour measured, every breath timed. Now the bells were gone. In their absence, the city’s heartbeat faltered, leaving a vacuum filled with confusion, grief, and hunger for something new. Erik and Calis stumbled through the rubble, witnesses not just to a tower’s fall, but to a society unraveling.',
      highlights: [
        {
          title: 'The Silence',
          content:
            'For the first time in memory, no bell marked the passing of time, throwing the city into disarray.',
        },
        {
          title: 'The Survivors',
          content:
            'Crowds gather in the plaza’s ruins, divided between mourning, celebration, and fear.',
        },
        {
          title: 'The Scarcity',
          content:
            'With the Clock’s collapse, its systems for rationing air, food, and water are shattered.',
        },
        {
        ...
        },
        {
          ...
          content:
            'Erik and Calis glimpse the dangerous currents already forming in the city’s veins.',
        },
      ],
      sections: [
        {
...

    {
      ...
      highlights: [
        ...
        },
        {
          ...
          content:
            'Each demon bore the mark of its master’s sacrificereflecting both strength and loss.',
        },
        {
        ...
        },
        {
          ...
          content:
            'Erik and Calis bore silent witness, drifting unseen as their city turned monstrous.',
        },
      ],
      sections: [
        {
...

    {
      ...
      highlights: [
        ...
        },
        {
          title: 'The Children',
          content:
            'They still dreamedof gardens, of rivers clean enough to swim in, of skies without smoke.',
        },
        {
          title: 'The Echoes of Erik and Calis',
          content:
            'Ghosts watching the living, haunted by memories of their own mother and father.',
        },
        {
      ...
      highlights: [
        {
          title: 'The Family',
          content:
            'A small household of fourmother, father, son, and daughterliving on the edge of ruin.',
        },
        {
          title: 'The Attack',
        ...
        },
        {
          title: 'The Sacrifice',
          content:
            'The parents stay behind, holding the demon long enough for their children to escape.',
        },
        {
        ...
        },
        {
          title: 'The Awakening',
          content:
            'The son’s grief and rage unlock his hidden half-demon naturehis power tied to protecting his sister, who reveals her own twisted heritage.',
        },
      ],
      sections: [
        {
      ...
      highlights: [
        {
          ...
          content:
            'A furnace-winged beast, its charred skin dripping embers, tethered by runes to its master.',
        },
        {
          title: 'Daren’s Gravity',
          content:
            'He discovers his powerable to bend weight, to crush or to lighten, though uncontrolled.',
        },
        {
          title: 'Selene’s Memory Vision',
          content:
            'Her eyes see past the present into memories etched into places, people, and objects.',
        },
        {
          title: 'The Struggle',
        ...
        },
        {
          ...
          content:
            'The siblings combine their powers, striking back not just at the demon, but at its summoner.',
        },
      ],
      sections: [
        {
...

    {
      ...
      highlights: [
        ...
        },
        {
          title: 'The Escape',
          content:
            'With a final trick, he severs the bond, leaving his demon to dissolve as he vanishes.',
        },
        {
          title: 'The Oath',
        ...
        },
        {
          title: 'The Aftermath',
          content:
            'Daren and Selene, scarred but alive, step forward into a city now aware of their power.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The night after the battle left more than scars on the siblings’ bodies  it left questions burning hotter than the flames of their ruined home. Daren and Selene knew the summoner hadn’t chosen them at random. Their family was marked. But why? With nothing left behind but smoke and whispers, they turned their steps toward the veins of the city, where answers lived in hidden places: the underground archives, the demon markets, and the mouths of those too afraid to speak. What they found would twist their grief into resolve, and their powers into weapons for survival.',
      highlights: [
        {
          title: 'Among the Ruins',
          content:
            'Sifting through what remained of their home, they find a clue left behind  a sigil burned into the foundation stone.',
        },
        {
          title: 'Into the City’s Underbelly',
          content:
            'Guided by Selene’s visions, they descend into the shadowed streets where summoners and their clients barter in whispers.',
        },
        {
          title: 'The First Rumors',
          content:
            'The siblings hear of a cult that pays in blood for demon power, led by shadow-brokers who seek out half-breeds like them.',
        },
        {
          title: 'A Growing Bond',
          content:
            'Daren struggles with the violence inside him, Selene grounds him with memory  together they begin shaping their powers with intent.',
        },
        {
          title: 'The Mark of the Enemy',
          content:
            'They learn the name of the summoner who destroyed their home: Veynar. A man with a demon mark etched into his chest, serving something larger than himself.',
        },
      ],
      sections: [
        {
        ...
        },
        {
          title: 'The First Rumors',
          content:
            'They sat in the back of a shadow-bar, overhearing what the fearful dared to mutter:',
          list: [
        ...
        },
        {
          title: 'The Mark of the Enemy',
          content:
            'Their hunt led them to an old archivist with milky eyes, who trembled at Selene’s touch on his ledger:',
          list: [
...

    {
      ...
      intro:
        'The siblings had a name now. Veynar. A face, a brand, a sworn enemy. But names drew attention, and the Ash Circle did not let their failures linger. As Daren and Selene huddled in the ruins of an abandoned chapel, patching their wounds and gathering what little strength they could, the shadows shifted. From those shadows came the Circle’s retribution: a hunter whose power warped reality itself. The siblings would learn that not every enemy could be crushed by gravity or unraveled by memory  some required wit, patience, and trust.',
      highlights: [
        {
          title: 'A Vulnerable Refuge',
          content:
            'The siblings find shelter in a ruined chapel, its stained glass shattered, its pews rotting.',
        },
        {
          title: 'The Assassin Arrives',
          content:
            'A cult hunter slips through the chapel walls, wielding a strange and disorienting power.',
        },
        {
          title: 'The Unique Ability',
          content:
            'His power bends perception  making attacks miss, walls shift, and memories misalign.',
        },
        {
          title: 'The Siblings Struggle',
          content:
            'Daren’s strength falters when he cannot trust his senses, and Selene’s visions turn chaotic.',
        },
        {
          title: 'The First Clue',
          content:
            'Together, they notice the flaw in the power: the assassin’s illusions unravel when he touches the ground.',
        },
      ],
      sections: [
        {
...

    {
      ...
      highlights: [
        ...
        },
        {
          ...
          content:
            'Selene grounds them both by forcing her memory-vision to cling to real moments rather than fractured illusions.',
        },
        {
          title: 'Daren’s Adaptation',
          content:
            'He stops chasing phantoms and starts shaping the battlefield itself with gravity.',
        },
        {
          title: 'The Assassin Pressed',
          content:
            'For the first time, the hunter’s confidence falters as his prey fights back with precision.',
        },
        {
          title: 'The Promise of Victory',
          content:
            'Though still wounded and cornered, the siblings glimpse the assassin’s fear  proof that the fight is not yet lost.',
        },
      ],
      sections: [
        {
...

    {
      ...
      highlights: [
        ...
        },
        {
          ...
          content:
            'The siblings synchronize their powers, collapsing the assassin’s tricks and striking true.',
        },
        {
          title: 'The Death Blow',
          content:
            'Daren delivers the finishing strike, crushing the assassin beneath a wave of gravity.',
        },
        {
          title: 'The Silence After',
          content:
            'The chapel stands ruined, but the siblings stand victorious  the first step on their path of vengeance.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The assassin lay broken in the chapel ruins, his illusions shattered, his body crushed beneath the weight of Daren’s will. For the first time since the fire that took their parents, the siblings had not merely survived  they had chosen the fight and won. But victory brought no comfort. It brought questions, exhaustion, and the creeping realization that every step forward would only draw the Circle’s eyes closer. In the stillness after battle, Daren and Selene found themselves reshaping who they were  no longer children of ash, but something harder, sharper, forged by loss and rage.',
      highlights: [
        {
          title: 'The Ruined Chapel',
          content:
            'The siblings rest among the shattered pews, the last flickers of candlelight casting broken shadows.',
        },
        {
          title: 'Counting the Cost',
          content:
            'Exhausted and wounded, they reckon with the toll of their fight and the risks of what comes next.',
        },
        {
          title: 'The Bond Between Them',
          content:
            'Selene steadies Daren’s anger with memory, while he swears to protect her no matter the cost.',
        },
        {
          title: 'A Path Forward',
          content:
            'They decide that hiding is no longer an option  they must hunt the Circle before it consumes them.',
        },
        {
          title: 'The First Clue',
          content:
            'From the assassin’s belongings, they uncover a lead that will point them deeper into the cult’s secrets.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The assassin’s body was cold, the chapel’s silence heavier than the grave. Daren and Selene stepped out into the night with a shard of obsidian and a name: Veynar. But vengeance required more than rage. They needed food, weapons, masks strong enough to breathe through the city’s rotting veins. And in the alleys between ruin and smoke, they found a man who promised such things  a wanderer named Corin. His smile was easy, his hands quick, his stories practiced. To Daren, he was a risk. To Selene, he was a chance. Neither saw the shadow beneath his words. Not yet.',
      highlights: [
        {
          title: 'Searching the Ash Streets',
          content:
            'The siblings scavenge for food and tools, the ruined markets offering more ghosts than goods.',
        },
        {
          title: 'Corin’s Entrance',
          content:
            'A rogue with supplies and stories, he inserts himself into their path with disarming charm.',
        },
        {
          title: 'Suspicion and Trust',
          content:
            'Daren bristles with distrust, while Selene allows Corin’s humor to lighten her burden.',
        },
        {
        ...
        },
        {
          ...
          content:
            'Corin leaves subtle cracks in his mask  a question asked too sharply, a glance that lingers too long on their obsidian shard.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'With Corin at their side, Daren and Selene left the city’s broken bones behind and walked into the ashlands. The road was no road at alljust a scar of blackened stone winding through fields of dead grass and hollow villages. Along the way, they learned to walk in uneasy rhythm with their new companion. Corin’s stories carried laughter, Selene’s questions carried hope, and Daren’s silence carried warning. But the road does not lie; it reveals. And in the long miles of dust and firelight, cracks began to spread, small enough to ignore, sharp enough to cut later.',
      highlights: [
        {
          title: 'Through the Ashlands',
          content:
            'A bleak journey across ruined fields and abandoned villages, each step reminding them of what the Circle’s touch had stolen.',
        },
        {
          title: 'Corin’s Stories',
          content:
            'The rogue fills silence with tales of his travels  some humorous, some heroic, some too convenient to believe.',
        },
        {
          title: 'Sibling Tension',
          content:
            'Selene warms to Corin’s charm, while Daren bristles with growing mistrust, widening the divide between brother and sister.',
        },
        {
          title: 'Echoes of Other Summoners',
          content:
            'The road offers glimpses of other survivors  and the costs they’ve paid to bind demons to their will.',
        },
        {
          title: 'The First Crack',
          content:
            'A slip in Corin’s mask  a name uttered too sharply, a look that lingers too long  plants a seed of doubt they cannot yet confront.',
        },
      ],
      sections: [
        {
      ...
      highlights: [
        {
          ...
          content:
            'The siblings witness the black horizon swelling, the air tasting of metal and burning paper.',
        },
        {
          title: 'Running Blind',
          content:
            'They enter the storm with rags over their faces, stumbling through choking dust and blinding winds.',
        },
        {
          title: 'Corin’s Guidance',
          content:
            'Corin proves his worth, leading them by instinct and memory, his laughter cutting through the storm’s roar.',
        },
        {
          title: 'Clinging to Life',
          content:
            'Selene falters under the weight of the storm, and Daren nearly unleashes his power to clear the path, but Corin steadies them both.',
        },
        {
          title: 'The Market Revealed',
          content:
            'At dawn, the storm recedes, unveiling the Hollow Market  a place of smoke, secrets, and whispers of the Circle.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The Hollow Market was not a marketplace in the human sense. It was a carnival of whispers, smoke, and silent trades. Beneath it all, hidden behind bone-carved gates, lay the Pits  great hollowed arenas where blood bought power and spectacle bought loyalty. Here, demonmasters tested their slaves, warriors proved their worth, and challengers rose or died in firelit sand. Daren and Selene, pressed by the Market’s watchful eyes, found themselves in such a place. And when a swordsman demon called them weaklings unfit for the Circle’s attention, Daren stepped into the arena  horn broken, power silenced, his only weapon a borrowed blade and his sister’s guiding visions.',
      highlights: [
        {
          title: 'The Pits of the Market',
          content:
            'A massive amphitheater carved underground, ringed with bone torches and seats of stone, where the Market gathered to watch bloodsport.',
        },
        {
          title: 'The Swordsman Demon',
          content:
            'A towering figure with a jagged blade and speed that blurred, his strikes carrying the weight of centuries of duels.',
        },
        {
          title: 'Daren’s Horn Broken',
          content:
            'The demon’s first strike shatters Daren’s horn, cutting him off from his gravity gift until it regrows.',
        },
        {
          title: 'Selene’s Gift',
          content:
            'Selene channels her memory-visions into flashes of the demon’s movements, whispering predictions for Daren to follow.',
        },
        {
          title: 'The Way of the Blade',
          content:
            'Forced to rely on steel and instinct, Daren learns rhythm, patience, and the weight of a warrior’s stance.',
        },
      ],
      sections: [
        {
...

    {
      title: 'Ash and Steel',
      intro:
        'Blood stained the sand of the Pit, but it was not Daren’s. The swordsman demon, beaten and bound, fell silent before the siblings’ will. His master  a cultist who had jeered the loudest  begged for mercy, and received none. The crowd roared, not with mockery now, but with something closer to respect. For a moment, Daren and Selene were no longer prey. They were predators who had carved their place with steel and vision. And when the dust settled, the Hollow Market opened its gates  a labyrinth of trade and whispers where power was bought with more than coin. Armed with victory and new knowledge, they turned their steps once more to vengeance, the road calling them beyond the Market’s smoke.',
      highlights: [
        {
          title: 'The Demon Conquered',
          content:
            'With Selene’s guidance and his newfound blade skill, Daren drives the sword through the demon’s chest, binding it into silence.',
        },
        {
          title: 'The Master Falls',
          content:
            'The cultist screams for his demon’s return but is struck down, leaving his body as a warning in the Pit.',
        },
        {
          title: 'The Market’s Respect',
          content:
            'The crowd, once jeering, now chants the siblings’ names, offering them a fragile kind of fame.',
        },
        {
          title: 'Shopping in Shadows',
          content:
            'They wander the Hollow Market, trading scraps and blood-won trophies for tools, supplies, and whispers.',
        },
        {
          title: 'The Next Clue',
          content:
            'A black-tongued trader reveals the next name in the Circle’s chain: Malrec, said to dwell beyond the ashroad in the ruins of an old fortress.',
        },
      ],
      sections: [
        {
...

    {
      title: 'The Ashroad',
      intro:
        'Leaving the Hollow Market behind, Daren and Selene step onto the ashroad  a scar that winds through landscapes both poisoned and alive in ways no human hand could have intended. The path to Malrec’s fortress is not just a road but a trial, lined with flora that drinks from blood and fauna that thrives on the weakness of travelers. Every step away from the Market feels like stepping deeper into another world, one that hums with danger, beauty, and secrets too old to be named.',
      highlights: [
        {
          title: 'The Blasted Trees',
          content:
            'Forests of skeletal blackwood rise from the earth, their bark still smoldering from long-forgotten fires, their roots curling like claws above the soil.',
        },
        {
          title: 'Predators of the Dust',
          content:
            'Ash-grey lizards with glassy spines stalk the road, their cries like breaking bottles echoing across the wastes.',
        },
        {
          title: 'The Living Pools',
          content:
            'Pools of liquid shimmer red and gold in shallow craters, but are alive  colonies of organisms that breathe like lungs, exhaling toxic fumes.',
        },
        {
          title: 'Whispers in the Wind',
          content:
            'At night, voices drift across the plains, sometimes human, sometimes not. Selene swears she hears her mother’s lullaby carried by the air.',
        },
        {
          title: 'The Shadow of Malrec',
          content:
            'On the horizon, through smoke and storm, the jagged silhouette of the fortress begins to emerge, carved into the bones of a mountain.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'Exhausted and frayed by the road, the siblings make camp beneath the fractured shell of an ancient archway. For the first time since leaving the Hollow Market, sleep takes them both  and in that sleep, Malrec comes. The fortress lord does not send a scout or a beast but himself, stepping into their minds like a storm breaking a door. In the dream, there is no hiding, no strength, no escape. There is only the taste of his power, and the crushing reminder of how small they are before him. When dawn comes, they wake with wounds that should not be possible, and the looming fortress gates rise before them.',
      highlights: [
        {
          title: 'The Archway Camp',
          content:
            'They rest in the ruins of an old empire’s gate, the night pressing down heavier than before.',
        },
        {
          title: 'Malrec Appears',
          content:
            'The dream begins with footsteps echoing through black mist, Malrec’s eyes burning with silver fire.',
        },
        {
          title: 'The Nightmare Duel',
          content:
            'Daren draws his blade, Selene summons visions, but Malrec sweeps them aside with casual cruelty.',
        },
        {
          title: 'The Mark of Defeat',
          content:
            'Selene’s arm burns with a phantom wound, and Daren wakes coughing blood  proof the dream was no illusion.',
        },
        {
          title: 'The Fortress Gates',
          content:
            'Through smoke and storm, the gates of Malrec’s domain finally loom, as though waiting for them all along.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The gates of Malrec’s fortress are no ordinary iron and stone. They breathe, whisper, and test those who dare approach. Chains thick as trees shift and groan, forming a mouth that speaks in a dozen voices at once. To pass, Daren and Selene are not asked for strength, nor for sacrifice, but for loyalty  to Veynar, the master who sits above Malrec. The quiz is mocking, cruel, and impossible to win honestly. Yet survival demands an answer.',
      highlights: [
        {
          title: 'The Living Gates',
          content:
            'The fortress gates are chained shut with links that twist into the shape of faces, each one mouthing questions.',
        },
        {
        ...
        },
        {
          ...
          content:
            'Daren spits blood, Selene clenches her shard  and together, they lie, swearing loyalty to Veynar.',
        },
        {
          title: 'The Chains Unlock',
          content:
            'Satisfied or deceived, the chains rattle and withdraw, revealing the darkness within.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'With the Ice Devil slain and its altar shattered, silence settles over the chamber like a shroud. But the fortress is alive, its walls humming with voices too faint to ignore. As Daren and Selene stagger deeper, they stumble into forgotten halls lined with carvings, murals, and records of Malrec’s rise under Veynar’s shadow. Here, lore and horror intertwine: the fortress is not merely a prison of demons, but a monument to their master. In learning its secrets, the siblings understand not only Malrec’s power but the true reach of Veynar.',
      highlights: [
        {
          title: 'The Murals of Blood',
          content:
            'Crimson-painted walls depict Malrec kneeling before Veynar, offered chains of souls as tribute.',
        },
        {
          title: 'The Tome of Chains',
          content:
            'An ancient book describes the pact: Malrec was granted dominion over altars in exchange for eternal servitude.',
        },
        {
          title: 'The Origin of the Fortress',
          content:
            'The structure was once a mountain-city of men, consumed and reshaped by demonic will.',
        },
        {
          title: 'Veynar’s Voice',
          content:
            'A whisper slithers through the hall  not memory, but the living echo of Veynar himself.',
        },
        {
          title: 'A Warning',
          content:
            'The fortress tells them plainly: destroying the altars is tearing pieces from Malrec, but each one awakens Veynar’s attention more sharply.',
        },
      ],
      sections: [
        {
...

    {
      ...
      highlights: [
        ...
        },
        {
          ...
          content:
            'They recall a night from childhood, their mother’s voice telling them no chain can bind two hearts that trust each other.',
        },
        {
          title: 'The Decision',
          content:
            'Bound by blood and memory, they choose to stand together, vowing to end Malrec even if Veynar himself awakens.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The chapel’s warmth vanishes the moment they step into the next chamber. The air is thick, coppery, every breath like drinking from a wound. At the altar stands the Blood Devil, a towering figure whose veins glow scarlet, skin split by rivers of boiling blood. With every step, streams burst from his arms and whip into high-pressured jets, cutting through stone like paper. This battle is not enduranceit is survival by wit and precision, where Daren and Selene’s bond is tested against blood itself.',
      highlights: [
        {
          title: 'The Chamber of Veins',
          content:
            'The walls are alive with pulsing red lines, veins feeding into the Blood Devil’s altar.',
        },
        {
          title: 'The Blood Devil’s Power',
          content:
            'He launches streams of compressed blood like blades, coating the ground with slick, burning fluid.',
        },
        {
          title: 'Daren’s Risk',
          content:
            'By applying gravity to his own blood, he forces his heart to pump harder, making himself faster and strongerbut at the cost of his life.',
        },
        {
          title: 'Selene’s Vision',
          content:
            'She reads the Blood Devil’s memories and predicts each strike, whispering the openings to Daren mid-battle.',
        },
        {
          title: 'The Heart in His Hands',
          content:
            'Selene spots the truth: the Blood Devil’s heart pulses not in his chest, but in his swollen, clawed hands.',
        },
        {
          title: 'Victory',
          content:
            'Daren, guided by Selene’s foresight, drives his blade through the demon’s hands, shattering the altar and silencing the bloody tide.',
        },
      ],
      sections: [
        {
...

    {
      ...
      highlights: [
        ...
        },
        {
          title: 'Selene’s Care',
          content:
            'She tends to him, furious at his recklessness but unwilling to let him see her fear.',
        },
        {
          title: 'The Fortress Responds',
          content:
            'With the Blood Devil dead, the walls shift, bones cracking in the dark corridors ahead.',
        },
        {
...

    {
      ...
      highlights: [
        ...
        },
        {
          ...
          content:
            'He wields his own skeleton like a weapon, sprouting blades and spears from his limbs.',
        },
        {
        ...
        },
        {
          ...
          content:
            'Daren’s gravity crushes skeletons but strains his body further with each surge.',
        },
        {
          title: 'Selene’s Predictions',
          content:
            'She guides Daren through the onslaught, but the Bone Devil adapts quickly, learning her rhythm.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The first wave of skeletons lies shattered, but the Bone Devil does not falter. He laughs, the sound like ribs snapping, and his body cracks apart. From his spine, wings of sharpened bone unfurl; from his arms, claws elongate into scythes. His skull splits, revealing a second jaw lined with jagged teeth. The chamber itself trembles with his transformation. Daren and Selene are forced back, regrouping mid-battle to find a way through this evolving nightmare.',
      highlights: [
        {
          title: 'The Transformation',
          content:
            'The Bone Devil mutates, sprouting wings, scythe-like claws, and a monstrous second jaw.',
        },
        {
          title: 'Unleashing Bone Storms',
          content:
            'He spins and shatters his own ribs, flinging shards of bone as a deadly storm of shrapnel.',
        },
        {
          title: 'The Siblings Pressured',
          content:
            'Daren struggles to keep pace, while Selene’s foresight is clouded by overlapping, chaotic memories.',
        },
        {
          title: 'A Tactical Retreat',
          content:
            'They dive into the shadows of a collapsed wall, catching their breath and recalibrating mid-battle.',
        },
        {
          title: 'A New Strategy',
          content:
            'Selene realizes his transformation spread his power thin; Daren sees an opening if they can force him into overextending his wings.',
        },
      ],
      sections: [
        {
...

    {
      ...
      highlights: [
        ...
        },
        {
          ...
          content:
            'Every strike forces Daren and Selene into pure survival, their earlier optimism erased.',
        },
        {
          title: 'Selene Overloaded',
          content:
            'Her foresight drowns under a flood of murderous memories, leaving her gasping and disoriented.',
        },
        {
          title: 'The Final Test',
          content:
            'Cornered and bleeding, Daren braces himself for a last stand, refusing to break.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The Bone Devil’s final form presses Daren and Selene to their breaking point. Every strike lands heavier, every moment bleeds hope away. Daren’s gravity falters under the strain, and Selene’s foresight collapses into a haze of death. The siblings, once united in perfect rhythm, stumble apart as despair threatens to consume them both.',
      highlights: [
        {
          title: 'The Tail Strikes True',
          content:
            'The Bone Devil’s bladed spine lashes through Daren’s defenses, carving deep into his side.',
        },
        {
          title: 'Selene’s Collapse',
          content:
            'Overwhelmed by visions of endless death, Selene screams and crumples to the ground.',
        },
        {
          title: 'The Mockery',
          content:
            'The Bone Devil toys with them, cutting shallow wounds and laughing at their weakness.',
        },
        {
          title: 'A Fractured Bond',
          content:
            'For the first time, Daren and Selene fight out of sync, their unity broken under pressure.',
        },
        {
...

    {
      ...
      highlights: [
        ...
        },
        {
          ...
          content:
            'For the first time in the battle, the Bone Devil reels backward, roars faltering.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'With his tail severed and his form faltering, the Bone Devil unleashes every shred of his monstrous power in a desperate bid to survive. The altar chamber shakes with his fury, wings lashing, claws tearing, bone shards raining like hail. Daren and Selene, their bond reforged, press forward together for the final strike. The battle ends here.',
      highlights: [
        {
          title: 'The Last Storm',
          content:
            'The Bone Devil expends his remaining strength in a frenzied barrage that nearly buries the siblings.',
        },
        {
          title: 'Selene’s Guiding Vision',
          content:
            'Her foresight cuts cleanly now, giving Daren the exact timing he needs to survive.',
        },
        {
          title: 'Daren’s Gravity Well',
          content:
            'He pours his life force into one last surge of power, dragging the Bone Devil down to the altar floor.',
        },
        {
          title: 'The Final Blow',
          content:
            'Guided by Selene’s vision of the heart hidden deep in his sternum, Daren drives his blade through it.',
        },
        {
          title: 'The Altar Shattered',
          content:
            'The Bone Devil’s body collapses into ash, the altar cracks and falls silent, and the siblings stand victorious.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'With the Bone Devil’s ashes still clinging to their clothes, Daren and Selene stand at the edge of the fortress’s deepest sanctum. Three altars have fallen, their demonic guardians destroyed. Only one remainsthe altar that fuels Malrec himself. The siblings know this battle will not just test their strength, but decide the fate of everything they’ve fought for. The road leads only forward, into the throne of darkness.',
      highlights: [
        {
          title: 'The Fortress Shudders',
          content:
            'With the third altar destroyed, the fortress itself trembles, walls cracking as power drains away.',
        },
        {
          title: 'Selene’s Fear',
          content:
            'Her visions are cloudy, filled with glimpses of Malrec’s towering form, but no clear path to victory.',
        },
        {
          title: 'Daren’s Resolve',
          content:
            'Wounded but unbroken, he sharpens his blade and swears they’ll finish what they started.',
        },
        {
          title: 'The Descent',
          content:
            'They journey deeper, through ruined halls lined with the corpses of demons who bent the knee to Malrec.',
        },
        {
          title: 'The Altar of Kings',
          content:
            'At last, they stand before the final chamber, where Malrec waits upon his throne, his altar burning with dark flame.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'Before blades are drawn, words are exchanged. Daren and Selene stand in the throne chamber of Malrec, the towering warlord whose power flows from the altar and the shadow of Veynar himself. Their final trial in this fortress begins not with steel, but with temptation and truth.',
      highlights: [
        {
          title: 'Malrec’s Throne',
          content:
            'A seat of bone and iron, where the warlord sits draped in crimson robes, his horns crowned with rings of gold.',
        },
        {
          title: 'The Weight of Presence',
          content:
            'The air thickens as his gaze falls on them, crushing them as if his will alone were a weapon.',
        },
        {
          title: 'Revealing Veynar',
          content:
            'Malrec speaks of his master openly, describing Veynar not as a god but as inevitability itself.',
        },
        {
          title: 'Temptation',
          content:
            'He offers Daren and Selene power, a place at his side, and survivalif they bow.',
        },
        {
          title: 'Defiance',
          content:
            'The siblings refuse, their resolve hardening even as they glimpse the impossible scale of the fight to come.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The throne chamber erupts in violence. Malrec rises from his seat, every step shaking the floor, every breath scorching the air. Daren and Selene launch the first strike, but quickly realize the gulf between themselves and the warlord of Veynar. The battle for survival begins.',
      highlights: [
        {
          title: 'The First Strike',
        ...
        },
        {
          ...
          content:
            'Her visions race, but Malrec’s movements blur, splitting into afterimages she can’t follow.',
        },
        {
          title: 'The Altar’s Flames',
          content:
            'The crimson fire behind Malrec roars, healing his wounds as quickly as they land.',
        },
        {
...

    {
      ...
      intro:
        'Malrec toys with the siblings, confident in his power. Yet in their desperation, Daren and Selene strike unexpectedly, cutting him deeper than he imagined. The warlord rises in fury, revealing the true extent of his abilities: the Dominion Chains, a power that binds body and soul alike.',
      highlights: [
        {
          title: 'Mockery',
        ...
        },
        {
          title: 'An Opening',
          content:
            'Selene’s vision spots a flicker, and Daren’s blade finally carves through his guard.',
        },
        {
          title: 'The Wound',
        ...
        },
        {
          ...
          content:
            'Molten bone and shadow weave into chains that lash out, binding body and soul, crushing hope itself.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The Dominion Chains close in, binding Daren’s body and Selene’s mind. Malrec’s laughter fills the chamber as he believes his victory certain. Yet in the suffocating grip of his power, the siblings begin to see cracksseeds of hope, and a strategy to break free.',
      highlights: [
        {
        ...
        },
        {
          ...
          content:
            'Selene is pulled into illusions of servitude, visions of herself kneeling before Veynar.',
        },
        {
        ...
        },
        {
          title: 'A Realization',
          content:
            'Selene notices that the chains react to Malrec’s heartbeatthey are extensions of his will, not unbreakable.',
        },
        {
          title: 'The Seed of Strategy',
          content:
            'Daren resolves to use gravity not to break the chains directly, but to destabilize Malrec’s own body and heartbeat.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The Dominion Chains tighten, threatening to end it all. Selene drowns in illusions of servitude, Daren’s bones crack under the weight of Malrec’s power. At the breaking point, a spark ignites in Darena new ability that turns despair into defiance. The chains are about to break.',
      highlights: [
        {
          title: 'The Crushing Grip',
          content:
            'Malrec’s chains constrict, splintering Daren’s ribs and dragging Selene deeper into submission.',
        },
        {
        ...
        },
        {
          ...
          content:
            'Daren unlocks a new ability: the power to create a singularity, pulling all chains and matter into collapse.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'Daren’s Event Horizon devours Malrec’s Dominion Chains, collapsing the battlefield into chaos. But Malrec refuses defeat, forcing his own chains into the singularity until it implodes, leaving both warriors drained of power. Exhausted and stripped of abilities, they face each other as mennot demons, not champions of gods. The battle ends in fists.',
      highlights: [
        {
          title: 'The Implosion',
          content:
            'Malrec drives his chains into the singularity, collapsing it in a burst of shockwaves.',
        },
        {
          title: 'The Aftermath',
          content:
            'The altar flickers, the chamber shakes, and both warriors stagger to their feet, drained of power.',
        },
        {
          title: 'Respect',
          content:
            'Malrec acknowledges Daren as a warrior, not just a pest, and demands a fight worthy of men.',
        },
        {
          title: 'The Fistfight',
        ...
        },
        {
          ...
          content:
            'She watches, powerless to intervene, her visions showing only one truth: one will fall.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The throne room falls silent save for fists and labored breaths. At last, the warlord of Veynar staggers, the last of his chains gone. With a final exchange, one warrior falls, and the altar that bound him crumbles. The siblings stand victorious, but not without cost.',
      highlights: [
        {
          title: 'The Last Blow',
          content:
            'Daren summons the last of his strength and lands a decisive punch square to Malrec’s jaw.',
        },
        {
          title: 'The Warlord’s Fall',
          content:
            'Malrec stumbles back, smiling even as his body collapses, finally acknowledging defeat.',
        },
        {
          title: 'The Altar’s Ruin',
          content:
            'The crimson altar cracks, flames guttering out as the fortress quakes around them.',
        },
        {
          title: 'Selene’s Tears',
          content:
            'She holds her brother upright, her visions confirming Malrec’s endbut also hinting at Veynar’s shadow looming larger still.',
        },
        {
          title: 'The Aftermath',
          content:
            'Malrec dies with honor, chains fading to dust, leaving behind only silence and ruin.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The fortress does not die with Malrec. Beneath the crumbling stones, secrets remainfragments of lore, whispers of Veynar’s dominion, and signs of the next warlord rising. The siblings press deeper into the ruins, seeking understanding before the world plunges into greater darkness.',
      highlights: [
        {
          title: 'The Hollow Throne',
          content:
            'Malrec’s seat remains, but upon it, burned inscriptions tell of his oath to Veynar.',
        },
        {
          title: 'The Vault Below',
          content:
            'A hidden passage opens beneath the throne, leading to a vault of broken chains and ritual tomes.',
        },
        {
          title: 'Selene’s Vision',
          content:
            'Her sight reveals the memory of Veynar himself speaking to Malrec, branding him with chains of loyalty.',
        },
        {
          title: 'The Whisper of Names',
          content:
            'On the vault walls are etched the names of other warlords still serving Veynar, one glowing brighter than the rest.',
        },
        {
          title: 'The Lingering Presence',
          content:
            'A shadow fills the vault, a trace of Veynar’s will, promising that this victory means nothing.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'Malrec’s fortress lies in ruin, but beyond it, a hidden truth emerges. The siblings discover an island cityshimmering and untouchedwhere the wealthy thrived under Malrec’s oppression. His fall has shaken their security, and now the siblings must confront those who profited while others bled.',
      highlights: [
        {
          title: 'Crossing the Wreckage',
          content:
            'The siblings pass through the ruins of the fortress and find a hidden causeway leading to an island cloaked in mist.',
        },
        {
          title: 'A City of Excess',
          content:
            'Behind the walls, luxury flourishesgleaming villas, gardens fed by enslaved labor, and air thick with the scent of spiced wine.',
        },
        {
          title: 'The Survivors’ Anger',
          content:
            'Locals, once bound by Malrec’s chains, now struggle to grasp freedom, clashing with the island’s wealthy elite.',
        },
        {
          title: 'The Gilded Defense',
          content:
            'The rich claim they were victims too, insisting their wealth was a survival pact with Malrec, not allegiance.',
        },
        {
          title: 'The Shadow of Zerath',
          content:
            'Whispers in the city speak of fire on the horizonthe rise of another warlord, Zerath, whose influence already reaches the island.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'The siblings demand answers from the island’s elites. What begins as denial soon unravels into revelation: the nobles are no victims, but occultists, spies for Zerath. Their final act of devotion summons fire and ruin, leaving the siblings alive but surrounded by ash and silence.',
      highlights: [
        {
          title: 'The Confrontation',
        ...
        },
        {
          title: 'The Ritual',
          content:
            'As the siblings press further, the elites chant, summoning an explosive inferno.',
        },
        {
          title: 'Daren’s Shield',
          content:
            'With seconds to act, Daren bends gravity into a dome, shielding himself and Selene.',
        },
        {
          title: 'The Ashes of the Innocent',
          content:
            'The villagers perish in the flames; only the siblings survive, stepping into silence and guilt.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        'Amid the ruins of fire and ash, the siblings discover one survivorbroken, dying, but still clinging to life. With their final breaths, the survivor offers a warning, a fragment of truth about Zerath’s growing dominion. The siblings leave the island with grief in their hearts and fire in their eyes.',
      highlights: [
        {
        ...
        },
        {
          title: 'The Survivor',
          content:
            'From the rubble, a villager pulls themselves free, body burned but spirit unbroken.',
        },
        {
          title: 'The Warning',
          content:
            'They whisper of Zerath’s coming war and his agents already embedded in distant cities.',
        },
        {
        ...
        },
        {
          title: 'Departure',
          content:
            'The siblings leave the island, determined to face the storm awaiting them beyond the sea.',
        },
      ],
      sections: [
        {
...

    {
      ...
      highlights: [
        ...
        },
        {
          ...
          content:
            'The siblings recount how the power plant explosion twisted humanity into the first cursed race.',
        },
        {
          title: 'Kael Hoff’s Fall',
          content:
            'Memories resurface of the man who ended the Ash Bloods, only to be consumed by them in turn.',
        },
        {
          title: 'The Clock Tower',
          content:
            'The monstrous tower built from Hoff’s body and spirita monument to their despair.',
        },
        {
          title: 'Rebirth into Demons',
          content:
            'The Ash Bloods’ death became not an end, but a transformation into demonsthe cycle continuing.',
        },
        {
          title: 'A Personal Revelation',
          content:
            'Daren and Selene face the truth that their parents were Ash Bloods reborn, their bloodline cursed to carry this legacy.',
        },
      ],
      sections: [
        {
...

    {
      ...
      intro:
        "Three days have passed since witnessing Kazuki's dominance in the Tournament of Echoes. With their supplies gathereddemon-steel rope coiled in their packs, ward-stones pulsing with protective energy, crystallized mana cores humming with stored powerDaren finds himself unable to forget the rhythm that governs the seemingly unbeatable fighter. As they prepare to leave Kaizahara, a chance encounter with the tournament's organizers changes everything. Daren's analytical mind has found the pattern, and his pride demands he test his theory against the legend himself.",
      sections: [
        {
...
.content-enhancement-container * {
  ...
  function displaySearchResults(results, query) {
    ...
    results.forEach((result) => {
      ...
      appendHighlightedText(
        excerptP,
        (result.article.intro || '').substring(0, 120) + '...',
        query
      );
  ...
  function initContentEnhancement() {
    ...
    console.log(
      'Content Enhancement: Successfully initialized with',
