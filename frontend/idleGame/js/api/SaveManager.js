...
class SaveManager {
  ...
  mergeGameData(localData, serverData) {
    ...
    if (localProgress > serverProgress) {
      ...
      merged.totalStoneMined = Math.max(
        localData.totalStoneMined || 0,
        serverData.totalStoneMined || 0
      );
      merged.totalStoneSold = Math.max(
        localData.totalStoneSold || 0,
        serverData.totalStoneSold || 0
      );
      merged.totalGoldEarned = Math.max(
        localData.totalGoldEarned || 0,
        serverData.totalGoldEarned || 0
      );
      ...
      merged.housingCapacity = Math.max(
        localData.housingCapacity || 0,
        serverData.housingCapacity || 0
      );
      merged.basicMarketers = Math.max(
        localData.basicMarketers || 0,
        serverData.basicMarketers || 0
      );
      merged.advancedMarketers = Math.max(
        localData.advancedMarketers || 0,
        serverData.advancedMarketers || 0
      );
      merged.expertMarketers = Math.max(
        localData.expertMarketers || 0,
        serverData.expertMarketers || 0
      );
      ...
      merged.prestigePoints = Math.max(
        localData.prestigePoints || 0,
        serverData.prestigePoints || 0
      );
      merged.totalPrestigeResets = Math.max(
        localData.totalPrestigeResets || 0,
        serverData.totalPrestigeResets || 0
      );
