class RebirthThemes {
  ...
  initializeThemes() {
    return [
      ...
      },
      {
        ...
        crafting: {
          basic: { title: 'Wash Produce', emoji: '🧺', result: 'Fresh Salads', inputs: 'Produce' },
          intermediate: {
            title: 'Prepare Meals',
            emoji: '👨‍🍳',
            result: 'Ready Meals',
      ...
      },
      {
        ...
        crafting: {
          basic: { title: 'Crush Ore', emoji: '⚒️', result: 'Raw Ingots', inputs: 'Raw Ore' },
          intermediate: {
            title: 'Smelt Metal',
            emoji: '🔥',
            result: 'Metal Bars',
      ...
      },
      {
        ...
        crafting: {
          basic: { title: 'Sort Junk', emoji: '♻️', result: 'Cleaned Items', inputs: 'Junk' },
          intermediate: {
            title: 'Repair Stuff',
            emoji: '🔧',
      ...
      },
      {
        ...
        crafting: {
          basic: { title: 'Break Down', emoji: '🔨', result: 'Useful Parts', inputs: 'Rubble' },
          intermediate: {
            title: 'Make Tools',
            emoji: '🔧',
            result: 'Crude Tools',
      ...
      },
      {
        ...
        crafting: {
          basic: { title: 'Find Twigs', emoji: '🌿', result: 'Kindling', inputs: 'Sticks' },
          intermediate: {
            title: 'Make Fire',
            emoji: '🔥',
            result: 'Warmth',
      ...
      },
      {
        ...
        crafting: {
          basic: { title: 'Breathe', emoji: '💨', result: 'Moments', inputs: 'Breaths' },
          intermediate: {
            title: 'Remember',
            emoji: '💭',
            result: 'Memories',
          ...
          advanced: { title: 'Accept', emoji: '🕊️', result: 'Peace', inputs: 'Memories + Therapy' },
          premium: { title: 'Let Go', emoji: '✨', result: 'Closure', inputs: 'Peace + Visitors' },
        },
        tabs: {
      ...
      },
      {
        ...
        crafting: {
          basic: { title: 'Feel', emoji: '💓', result: 'Sensation', inputs: 'Heartbeats' },
          intermediate: {
            title: 'Recall',
            emoji: '✨',
            result: 'Flashbacks',
      ...
      },
      {
        ...
        crafting: {
          basic: { name: '✨ Sparkle', result: '✨ Sparkle', emoji: '✨' },
          intermediate: { name: '✨ Glimmer', result: '✨ Glimmer', emoji: '✨' },
          advanced: { name: '✨ Shine', result: '✨ Shine', emoji: '✨' },
          premium: { name: '✨ Radiance', result: '✨ Radiance', emoji: '✨' },
        },
        transport: {
        ...
        upgrades: { efficiency: '✨ Transcendence', speed: '✨ Timelessness' },
  ...
  getTheme(e) {
    const i = Math.min(e, this.themes.length - 1);
    return this.themes[i];
  }
  getCurrentTheme(e) {
    const i = e.city?.rebirths || 0;
    return this.getTheme(i);
  }
  isGameEnded(e) {
    const i = e.city?.rebirths || 0;
    return this.getTheme(i).isEnding || !1;
  }
}
