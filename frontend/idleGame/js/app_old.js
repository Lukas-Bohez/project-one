...
class IndustrialEmpireApp {
  ...
  setupActionListeners() {
    ...
    this.bindButton('research-efficiency-btn', () =>
      this.gameEngine.purchaseResearch('efficiency')
    );
    ...
    this.bindButton('prestige-processing-btn', () =>
      this.gameEngine.applyPrestigeBonus('processing')
    );
    this.bindButton('prestige-trading-btn', () => this.gameEngine.applyPrestigeBonus('trading'));
    this.bindButton('prestige-transport-btn', () =>
      this.gameEngine.applyPrestigeBonus('transport')
    );
...
window.addEventListener('error', (event) => {
  ...
  if (window.app) {
    window.app.showNotification(
      'An error occurred. Please refresh if the game stops working.',
      'error'
    );
  }
});
