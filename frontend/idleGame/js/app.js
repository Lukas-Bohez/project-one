...
class IndustrialEmpireApp {
  ...
  updateArcadeUI() {
    ...
    games.forEach((game) => {
      ...
      button.className = game.unlocked
  ...
  setupActionListeners() {
    ...
    this.bindButton('transport-intermediate-btn', () =>
      this.gameEngine.toggleTransportCrafted('intermediate')
    );
    this.bindButton('transport-advanced-btn', () =>
      this.gameEngine.toggleTransportCrafted('advanced')
    );
    this.bindButton('transport-premium-btn', () =>
      this.gameEngine.toggleTransportCrafted('premium')
    );

    // Sell crafted items from city
    this.bindButton('sell-city-basic-btn', () => this.gameEngine.sellAllCraftedFromCity('basic'));
    this.bindButton('sell-city-intermediate-btn', () =>
      this.gameEngine.sellAllCraftedFromCity('intermediate')
    );
    this.bindButton('sell-city-advanced-btn', () =>
      this.gameEngine.sellAllCraftedFromCity('advanced')
    );
    this.bindButton('sell-city-premium-btn', () =>
      this.gameEngine.sellAllCraftedFromCity('premium')
    );
    ...
    this.bindButton('research-processing-btn', () =>
      this.gameEngine.purchaseResearch('processing')
    );
    this.bindButton('research-automation-btn', () =>
      this.gameEngine.purchaseResearch('automation')
    );
    ...
    this.bindButton('ad-convert-resources-btn', () =>
      this.gameEngine.watchAdForResourceConversion()
    );
