...
(function () {
    ...
    return e('div', { className: 'a-toolbar' }, [
      ...
      e(
        'select',
        {
          ...
          className: 'a-select',
          value: activeTag || '',
          onChange: (ev) => onTag(ev.target.value || null),
          'aria-label': 'Filter by tag',
        },
        [e('option', { value: '' }, 'All tags')].concat(
  ...
  function ArticleCard({ a }) {
    ...
    return e('article', { className: 'a-card', role: 'article' }, [
      ...
      e('div', { className: 'a-card__body' }, [
        ...
        e(
          'div',
          { className: 'a-card__meta' },
          `${new Date(a.date).toLocaleDateString()}${a.author ? ' • ' + a.author : ''}`
        ),
        fullDesc
          ? e(
              'p',
              { className: expanded ? 'a-card__desc a-card__desc--expanded' : 'a-card__desc' },
              expanded ? fullDesc : desc
            )
          : null,
        fullDesc && fullDesc.length > 120
          ? e(
              'button',
              {
        ...
        a.tags?.length
          ? e(
              'div',
              { className: 'a-card__tags' },
              a.tags.map((t) => e('span', { key: t, className: 'tag' }, t))
            )
          : null,
        e(
          'div',
  ...
  function ArticleList({ items }) {
    ...
    return e(
      'section',
      { className: 'a-grid' },
      items.map((a) => e(ArticleCard, { key: a.slug, a }))
    );
  }
