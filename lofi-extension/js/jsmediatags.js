...
$jscomp.polyfill = function (v, h, p, n) {
  if (h) {
    ...
    h != n &&
      null != h &&
      $jscomp.defineProperty(p, v, { configurable: !0, writable: !0, value: h });
  }
};
$jscomp.polyfill(
            ...
            t(
              ...
              [
                ...
                },
                {
                  ...
                  value: function (d, a) {
                    var e = this,
                      l = (this._blob.slice || this._blob.mozSlice || this._blob.webkitSlice).call(
                        this._blob,
                        d[0],
                        d[1] + 1
                      ),
            ...
            q(h, [
              {
                ...
                value: function (f, c) {
                  ...
                  if (-1 === g.startIx)
                    this._fileData.splice(g.insertIx || 0, 0, { offset: f, data: c });
                  else {
                  ...
                  value: function (a, d, e, b, l) {
                    ...
                    if (127 < e)
                      if (c._commentOffset) l.onSuccess();
                        ...
                        l.onError({ type: 'loadData', info: 'Comment block could not be found.' });
                    else
                ...
                },
                {
                  ...
                  value: function (a, d) {
                    ...
                    return {
                      type: 'FLAC',
                      version: '1',
                      tags: { title: l, artist: c, album: k, track: g, genre: u, picture: r },
                    };
                  },
                },
              ],
                ...
                },
                {
                  ...
                  value: function (a, e) {
                    ...
                    if (0 == h && 0 != e) {
                      ...
                      ((r = '1.0'), (h = a.getStringWithCharsetAt(d + 97, 30).toString()), (e = 0));
                  ...
                  for (var l = {}, k = this._getFrameHeaderSize(c); e < d - k; ) {
                    ...
                    if (!g || -1 !== g.indexOf(u)) {
                      ...
                      h &&
                        ...
                        ((m = this.getUnsyncFileReader(m, r, w)), (r = 0), (w = m.getSize()));
                ...
                },
                {
                  ...
                  value: function (a, b) {
                    ...
                    n.flags.unsynchronisation &&
                      ((a = g.getUnsyncFileReader(a, e, p)), (e = 0), (b = a.getSize()));
              ...
              [
                ...
                },
                {
                  ...
                  value: function (a, b) {
                    ...
                    c = g[c];
                    if ('trkn' == e)
                      var l = { track: a.getByteAt(b + 16 + 11), total: a.getByteAt(b + 16 + 13) };
                    else if ('disk' == e)
                      l = { disk: a.getByteAt(b + 16 + 11), total: a.getByteAt(b + 16 + 13) };
                    else {
                      b += 24;
                      var f = d - 24;
            ...
            t(
              ...
              [
                ...
                },
                {
                  ...
                  value: function (a, b, c) {
                    0 > e._config.disallowedXhrHeaders.indexOf(b.toLowerCase()) &&
                ...
                },
                {
                  ...
                  value: function (a, b) {
                    for (var d = [], e = [], f = a.getSize(), g = 0; g < u.length; g++) {
                      ...
                      c(h, f) &&
                        ((0 <= h.offset && h.offset < f / 2) || (0 > h.offset && h.offset < -f / 2)
                          ? d.push(u[g])
                          : e.push(u[g]));
                    }
                    var k = !1;
