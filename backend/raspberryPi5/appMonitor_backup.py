...
def monitor_app():
    ...
    while restart_count < max_restarts:
        ...
        if time.time() - monitor_start_time > max_monitor_runtime:
            print(f"⏳ Monitor has been running for {max_monitor_runtime//3600} hours - restarting...")
            restart_monitor()
        ...
        try:
            ...
            try:
                ...
                while process.poll() is None:
                    ...
                    if current_time - last_output_time > 300:
                        print("⚠️ No output for 5 minutes - assuming hang, restarting...")
                        restart_needed = True
                        restart_reason = "process hang detected (no output for 5 minutes)"
                        break
            ...
            restart_count += 1
            print(f"🔄 Restarting due to launch failure in 10 seconds... (restart #{restart_count})")
            time.sleep(10)
