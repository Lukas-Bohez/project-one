    ...
    try:
        ...
        if button_pressed:
            ...
            for button_index in sorted(button_pressed.keys()):
                print(
                    f"    {button_index}: 'BTN{button_index}',  # Update this with actual button name"
                )
            print("}")
                    ...
                    for combo in test_combinations:
                        if combo[0] in button_states and combo[1] in button_states:
                            if button_states[combo[0]] and button_states[combo[1]]:
                                print(
                                    f"*** COMBINATION DETECTED: {combo[0]} + {combo[1]} ***"
                                )
                                print(
                                    f"Update your code: SELECT = {combo[0]}, START = {combo[1]}"
                                )
