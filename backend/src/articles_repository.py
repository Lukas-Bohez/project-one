...
try:
    ...
    def create_article(title: str, author: str, date_written: str, story: str = None, 
        ...
        try:
            ...
            values = (title, author, date_written, story, content, excerpt, 
                     category, tags, word_count, reading_time_minutes, is_active, is_featured)
    ...
    def update_article(article_id: int, **kwargs) -> bool:
        ...
        try:
            ...
            allowed_fields = ['title', 'author', 'date_written', 'story', 'content', 
    ...
    def get_articles_stats() -> Dict[str, Any]:
        ...
        try:
            ...
            # Active articles
            cursor.execute("SELECT COUNT(*) as active FROM articles WHERE is_active = TRUE")
            stats['active_articles'] = cursor.fetchone()['active']
            
            # Featured articles
            cursor.execute("SELECT COUNT(*) as featured FROM articles WHERE is_featured = TRUE")
