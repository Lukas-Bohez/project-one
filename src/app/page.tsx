    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-sky-100 text-slate-900 dark:from-[#020617] dark:via-[#040a18] dark:to-[#0f172a] dark:text-slate-100">
      <main className="mx-auto w-full max-w-6xl p-6 sm:p-10">
        <header className="mb-12 rounded-3xl border border-slate-200 bg-white/75 p-8 shadow-lg backdrop-blur dark:border-slate-700 dark:bg-slate-900/70">
          ...
          <h1 className="mt-3 text-4xl font-bold leading-tight sm:text-5xl">Frontend Developer & Designer</h1>
          <p className="mt-4 max-w-2xl text-lg text-slate-600 dark:text-slate-300">
            Crafting accessible, responsive, and aesthetic web experiences with Next.js, TypeScript, and TailwindCSS.
            I love taking projects from concept to deploy, with clean code and strong UX.
          </p>
        ...
        <section className="mb-10 grid gap-5 md:grid-cols-2">
          <article className="rounded-2xl bg-white/80 p-6 shadow-sm dark:bg-slate-800/75">
            ...
            <p className="mt-3 text-slate-600 dark:text-slate-300">
              I’m a practicing web developer specializing in modern React/Next.js applications.
              I focus on performance, accessibility and maintenance through strong architecture and component design.
            </p>
          ...
          <article className="rounded-2xl bg-white/80 p-6 shadow-sm dark:bg-slate-800/75">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2 text-sm text-slate-700 dark:text-slate-300 sm:grid-cols-3">
              {['Next.js', 'React', 'TypeScript', 'TailwindCSS', 'HTML', 'CSS'].map((skill) => (
                <span key={skill} className="rounded-lg bg-slate-100 px-2 py-1 text-center dark:bg-slate-700">
                  {skill}
                </span>
              ))}
            </div>
          ...
          <div className="mt-5 grid gap-4 sm:grid-cols-2">
            <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
              ...
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
                A fully responsive and accessible portfolio built with Next.js App Router, typed with TypeScript, and styled using TailwindCSS.
              </p>
              <a
            ...
            <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
              ...
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
                Reusable components with strict types and built-in accessibility, including buttons, form fields, modals and dark mode support.
              </p>
              <a
                className="mt-4 inline-flex items-center text-sm font-semibold text-blue-700 hover:text-blue-900 dark:text-blue-300 dark:hover:text-blue-100"
                href="#"
        ...
        <section id="contact" className="rounded-2xl border border-slate-200 bg-white/80 p-6 shadow-sm dark:border-slate-700 dark:bg-slate-900/75">
